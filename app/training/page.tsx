...
export default function TrainingPage() {
  ...
  return (
    <div>
      <PageHeader
        crumbs={[{ label: "홈", href: "/" }, { label: "육성 / 시뮬레이션" }]}
